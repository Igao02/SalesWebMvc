...
namespace SalesWebMVC.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            SalesRecord r1 = new SalesRecord(new DateTime(2018, 09, 4), 7000.0, SalesStatus.Billed, s5);
            SalesRecord r2 = new SalesRecord(new DateTime(2022,8,5),8000.0, SalesStatus.Billed, s6);
            ...
            SalesRecord r13 = new SalesRecord(new DateTime(2018, 09, 29), 10000.0, SalesStatus.Canceled, s4);
            SalesRecord r14 = new SalesRecord(new DateTime(2018, 09, 4), 3000.0, SalesStatus.Billed, s5);
            SalesRecord r15 = new SalesRecord(new DateTime(2018, 09, 12), 4000.0, SalesStatus.Canceled, s1);
            ...
            SalesRecord r21 = new SalesRecord(new DateTime(2018, 10, 17), 9000.0, SalesStatus.Canceled, s2);
            ...
            SalesRecord r30 = new SalesRecord(new DateTime(2018, 10, 12), 5000.0, SalesStatus.Canceled, s2);
